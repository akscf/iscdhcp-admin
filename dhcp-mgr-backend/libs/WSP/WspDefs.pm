...
use constant RPC_ERR_CODE_INVALID_PROPERTY		=> 1002;
use constant RPC_ERR_CODE_ALREADY_EXISTS		=> 1003;
use constant RPC_ERR_CODE_NOT_FOUND			=> 1004;
use constant RPC_ERR_CODE_OUT_OF_DATE			=> 1005;
use constant RPC_ERR_CODE_PERMISSION_DENIED		=> 1006;
use constant RPC_ERR_CODE_UNAUTHORIZED_ACCESS		=> 1007;
