...
sub obj_create {
	...
	#
	if(!$entity || $entity->{'class'} ne DHCPADM::Models::LeaseEntry->MODEL_NAME) {
...
sub obj_update {
	my ($self, $entity) = @_;
	# 
	die WSP::WspException->new("OMAPI update doesn't work correctly\nas workaround you can delete and create a new object", RPC_ERR_CODE_INTERNAL_ERROR );
...
#		return 0; 
#	}
#	my $o = om_fill_lease_object($self, $map, DHCPADM::Models::LeaseEntry->new());
