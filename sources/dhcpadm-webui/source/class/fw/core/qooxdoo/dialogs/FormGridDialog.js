 ...
 * https://akscf.me/
 */
qx.Class.define("fw.core.qooxdoo.dialogs.FormGridDialog", {
        ...
        construct:function (captionText, captionIcon) {
            ...
            this.setWidth(450);
            //
            this.__fieldsContainer = new fw.core.qooxdoo.widgets.FormContainerGrid();
            //this.__fieldsContainer.set({padding:2});
