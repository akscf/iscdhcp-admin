 ...
 *
 */
qx.Class.define("org.cforge.qooxdoo.ui.upload.UploadField",
    {
        ...
        members:{
            ...
            _createChildControlImpl:function (id) {
                ...
                switch (id) {
                    case "button":
                        control = new org.cforge.qooxdoo.ui.upload.UploadButton(this.getFieldName(), this.getLabel(), this.getIcon());
